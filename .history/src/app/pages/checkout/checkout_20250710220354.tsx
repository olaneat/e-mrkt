...
const Checkout = () =>{
    ...
    const [publicKey, setKey] = useState<any>(env.REACT_APP_TEST_PK);
                ...
                return(
                  <div className="cart-item-detail" key={item.id}>
                    <div className="upper-detail">
                      <img src={`${env.VITE_IMG_URL}/${item.img}`} className="img-item" alt="" />
                      <div className="item-infor">
                        ...
                        <div className="price-qua-div">
                          ...
                          <div className="quantity">
                            <span className="increase-btn" onClick={changeQuantity('decrease', item.id)}>-</span>
